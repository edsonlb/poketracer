...
urlpatterns = patterns('',
	...
	url(r'^poketracer/logout/$', 'pessoas.views.pessoa_logout'),
	...
	url(r'^poketracer/home/$', 'pessoas.views.pessoa_url'),
	url(r'^poketracer/home/safari/$', 'pessoas.views.sarafi_url'),
	url(r'^poketracer/home/safari/add/$', 'pessoas.views.safari_adicionar'),
)
